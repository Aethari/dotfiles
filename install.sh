...
sudo xbps-install nano neovim xclip pulseaudio bluez i3 i3-gaps feh rofi tmux flatpak curl rxvt-unicode-9.31_5 xrdb git github-cli xrandr htop neofetch gcc make spectacle xset xz lxappearance ark
