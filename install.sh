...
sudo xbps-install nano neovim xclip pulseaudio bluez i3 i3-gaps feh rofi tmux flatpak curl rxvt-unicode xrdb git github-cli xrandr htop fastfetch gcc make spectacle xset xz lxappearance ark playerctl oneko irssi
